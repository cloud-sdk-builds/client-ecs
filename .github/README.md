...
[`@aws-sdk/client-ecs`](https://www.npmjs.com/package/@aws-sdk/client-ecs/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecs@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VoxJitDCALZ31uj330jimpGtegfjK2URXuM5NT+uXEDpUXG/XMgR/DebJup2synH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ecs": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecs@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecs@3.846.0/index.min.mjs": "sha384-VoxJitDCALZ31uj330jimpGtegfjK2URXuM5NT+uXEDpUXG/XMgR/DebJup2synH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ecs/blob/refs/tags/3.846.0/LICENSE
```
